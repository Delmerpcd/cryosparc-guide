...
- **修改流程**: 编辑 `index.source.html` → `npx staticrypt index.source.html -p PCD123123123 --short` → `mv encrypted/index.source.html index.html` → `rm -rf encrypted .staticrypt.json` → 提交推送
